...
class UI:
    ...
    def show_exp(self, exp):
        ...
        pygame.draw.rect(self.display_surface, UI_BG_COLOR, text_rect.inflate(30, 15))
        self.display_surface.blit(text_surf, text_rect)
        pygame.draw.rect(
            self.display_surface, UI_BORDER_COLOR, text_rect.inflate(30, 15), 3
        )
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(10, 512, has_switched)  # weapon
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(100, 512, has_switched)
