...
class Player(Entity):
    ...
    def animate(self):
        ...
        # loop over the frame frame_index
    ...
    def get_full_weapon_damage(self):
        ...
        weapong_damage = weapon_data[self.weapon]["damage"]

        return base_damage + weapong_damage
    ...
    def energy_recovery(self):
        if self.energy < self.stats["energy"]:
            self.energy += 0.01 * (self.stats["magic"] / 1.7)
        else:
            self.energy = self.stats["energy"]
